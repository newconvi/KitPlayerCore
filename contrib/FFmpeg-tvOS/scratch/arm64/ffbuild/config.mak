...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk appletvos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk appletvos clang' --enable-cross-compile --disable-debug --disable-programs --disable-indev=avfoundation --disable-doc --enable-pic --disable-shared --enable-static --enable-videotoolbox --disable-audiotoolbox --disable-encoders --disable-decoders --enable-decoder=aac --enable-decoder='pcm*' --enable-decoder='ac3*' --enable-decoder='eac3*' --enable-decoder=mp3 --enable-decoder='vp*' --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=opus --enable-decoder='mpeg4*' --disable-hwaccels --enable-hwaccel=h263_videotoolbox --enable-hwaccel=hevc_videotoolbox --enable-hwaccel=mpeg4_videotoolbox --enable-hwaccel=vp9_videotoolbox --enable-hwaccel=h264_videotoolbox --extra-cflags='-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode' --extra-ldflags='-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode' --prefix=/Users/ns/Documents/GitHub/playerPublic/contrib/FFmpeg-tvOS/thin/arm64
...
SRC_PATH=/Users/ns/Documents/GitHub/playerPublic/contrib/FFmpeg
SRC_LINK=src
...
CFLAGS=  -arch arm64 -mtvos-version-min=10.2 -fembed-bitcode -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
