...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=arm64 --cc='xcrun -sdk appletvos clang' --as='gas-preprocessor.pl -arch aarch64 -- xcrun -sdk appletvos clang' --enable-cross-compile --disable-debug --disable-programs --disable-indev=avfoundation --disable-doc --enable-pic --disable-shared --enable-static --enable-gpl --enable-videotoolbox --enable-version3 --disable-audiotoolbox --extra-cflags='-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode' --extra-ldflags='-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode' --prefix=/Users/ns/Downloads/tvos.mpv.player-master/contrib/FFmpeg-tvOS/thin/arm64
prefix=/Users/ns/Downloads/tvos.mpv.player-master/contrib/FFmpeg-tvOS/thin/arm64
...
SRC_PATH=/Users/ns/Downloads/tvos.mpv.player-master/contrib/FFmpeg
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Apple clang version 13.1.6 (clang-1316.0.21.2.5)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=_
...
CFLAGS=-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode  -arch arm64 -mtvos-version-min=10.2 -fembed-bitcode -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=-arch arm64 -mtvos-version-min=10.2 -fembed-bitcode -arch arm64 -mtvos-version-min=10.2 -fembed-bitcode  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
