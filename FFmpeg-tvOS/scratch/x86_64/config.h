...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=x86_64 --cc='xcrun -sdk appletvsimulator clang' --as='xcrun -sdk appletvsimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-indev=avfoundation --disable-doc --enable-pic --disable-shared --enable-static --enable-gpl --enable-videotoolbox --enable-version3 --disable-audiotoolbox --extra-cflags='-arch x86_64 -mtvos-simulator-version-min=10.2' --extra-ldflags='-arch x86_64 -mtvos-simulator-version-min=10.2' --prefix=/Users/ns/Downloads/tvos.mpv.player-master/contrib/FFmpeg-tvOS/thin/x86_64"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "/Users/ns/Downloads/tvos.mpv.player-master/contrib/FFmpeg-tvOS/thin/x86_64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/ns/Downloads/tvos.mpv.player-master/contrib/FFmpeg-tvOS/thin/x86_64/share/ffmpeg"
